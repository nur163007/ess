            ...
            <div class="row ml-1 mt-2">
                ...
                <div class="col-md-3 @if(\Auth::user()->role_id > 2){{'d-none'}}@endif">
                    <div class="form-group">
                        ...
                        <select id="warehouse_id" name="warehouse_id" class="selectpicker form-control" data-live-search-style="begins" >
        ...
        <table id="purchase-table" class="table purchase-list" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Purchase Due')}}</th>
{{--                    <th>{{trans('file.Shipping Due')}}</th>--}}
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<h1 class="text-center">Purchase List</h1><hr>'
                },
                action: function(e, dt, button, config) {
                    datatable_sum(dt, true);
