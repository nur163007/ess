                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lc_no" class="form-control" required placeholder="Give lc no" value="{{ $lims_purchase_data->lc_no }}"/>
                                        </div>
                                        @if ($errors->has('lc_no'))
...
//                                                        $product_batch_data = \App\ProductBatch::select('batch_no', 'expired_date')->find($product_purchase->product_batch_id);
                                                    ?>
                                                        ...
                                                        <td class="recieved-product-qty d-none"><input type="text" class="form-control recieved" name="recieved[]" value="{{$product_purchase->recieved}}" step="any"/></td>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="order_discount" class="form-control" value="{{$lims_purchase_data->order_discount}}" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="shipping_cost" class="form-control totalShipValue" value="{{$lims_purchase_data->shipping_cost}}" readonly step="any" />
                                        </div>
                                    </div>
                                </div>
...
{{--                                            <input type="hidden" name="shipping_agency_hidden" value="{{ $shipData->agency->id }}" />--}}
                                            <select name="shipping_agency[]" class="selectpicker form-control shippingAgency" required>
...
{{--                                            <input type="hidden" name="shipping_vehicle_no_hidden" value="{{$shipData->shipping_vehicle_no}}" />--}}
                                            <input type="text" name="shipping_vehicle_no[]" class="form-control" value="{{$shipData->shipping_vehicle_no}}" step="any">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
...
{{--                                            <input type="hidden" name="shipping_per_cost_hidden" value="{{$lims_purchase_data->shipping_vehicle_no}}" />--}}
                                            <input type="text" name="shipping_per_cost[]" class="form-control getShippingCost" value="{{$shipData->shipping_cost}}" step="any">
                                        </div>
                                    </div>
                                    @endforeach
                                    <div class="col-md-1">
                    ...
                    <form>
                        <div class="row modal-element">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" name="edit_qty" class="form-control" step="any">
                            </div>
                            <div class="col-md-4 form-group">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" name="edit_unit_cost" class="form-control" step="any">
                            </div>
                            <?php
                                $tax_name_all[] = 'No Tax';
                                $tax_rate_all[] = 0;
...
$('select[name="shipping_type"]').val($('input[name="shipping_type_hidden"]').val());
$('.shippingAgency').val($('input[name="shipping_agency_hidden"]').val()).change();
