                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lc_no" class="form-control" required placeholder="Give lc no"/>
                                        </div>
                                        @if ($errors->has('lc_no'))
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="order_discount" class="form-control" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="shipping_cost" class="form-control" readonly step="any" />
                                        </div>
                                    </div>
                    ...
                    <form>
                        <div class="row modal-element">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" id="totalunitcost" name="edit_unit_cost" class="form-control" step="any">
                            </div>
                            <?php
                                $tax_name_all[] = 'No Tax';
                                $tax_rate_all[] = 0;
...
<script type="text/javascript">
    ...
    $('button[name="update_btn"]').on("click", function() {
        ...
        if(edit_qty < 0.1) {
            ...
            edit_qty = 1;
            alert("Quantity can't be less than 0.5");
        }
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    if($('select[name="status"]').val() == 1)
                        cols += '<td class="recieved-product-qty d-none"><input type="text" class="form-control recieved" name="recieved[]" value="1" step="any"/></td>';
                    else if($('select[name="status"]').val() == 2)
                        cols += '<td class="recieved-product-qty"><input type="text" class="form-control recieved" name="recieved[]" value="1" step="any"/></td>';
                    else
                        cols += '<td class="recieved-product-qty d-none"><input type="text" class="form-control recieved" name="recieved[]" value="0" step="any"/></td>';
                    // if(data[10]) {
            ...
            $('<div>').attr({'class':'row'}).append(
                ...
                $('<div>').attr('class','col-md-2').append(
                    $('<select>').attr({'class':'form-control', 'data-style':'btn-select', 'name':'shipping_type[]', 'id':'shipping_type_'+id}).append(
                        ...
                        $('<option>').attr('value','3').html('Mother Vassel')
                    )
                )
            ).append(
