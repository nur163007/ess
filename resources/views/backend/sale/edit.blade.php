...
//                                                        $product_batch_data = \App\ProductBatch::select('batch_no', 'expired_date')->find($product_sale->product_batch_id);
                                                    ?>
                                                        ...
                                                        <td><input type="text" class="form-control qty" name="qty[]" value="{{$product_sale->qty}}" step="any" required/></td>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="order_discount_value" class="form-control" value="@if($lims_sale_data->order_discount_value){{$lims_sale_data->order_discount_value}}@else{{$lims_sale_data->order_discount}}@endif" step="any" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                {{trans('file.Shipping Total Cost')}}
                                            </label>
                                            <input type="text" name="shipping_cost" class="form-control" value="{{$lims_sale_data->shipping_cost}}" readonly step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                    ...
                    <form>
                        <div class="row modal-element">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" step="any" name="edit_qty" class="form-control">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>{{trans('file.Unit Discount')}}</label>
                                <input type="text" name="edit_discount" class="form-control">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>{{trans('file.Unit Price')}}</label>
                                <input type="text" name="edit_unit_price" class="form-control" step="any">
                            </div>
                            <?php
                                $tax_name_all[] = 'No Tax';
                                $tax_rate_all[] = 0;
              ...
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                      <label><strong>{{trans('file.Cash in Hand')}} *</strong> </label>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    cols += '<td>' + data[1] + '</td>';
                    cols += '<td><input type="text" class="form-control qty" name="qty[]" value="'+data[14]+'" step="any" required/></td>';
                    // if(data[12]) {
