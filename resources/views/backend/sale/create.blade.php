                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="warehouse_id" id="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select stockyard...">
...
{{--                                                    <th></th>--}}
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Order Discount Value')}}</label>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <input type="radio" id="ship1" name="shippingCheck" value="ship1" checked> <strong>Need Shipping</strong>
                                ...
                                <div id="agencyHide" class="row mt-4">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="shipping_agency[]" class="selectpicker form-control" data-live-search="true" required  id="requiedNot" title="Select agency...">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{trans('file.Shipping Total Cost')}}</strong>
                                            </label>
                                            <input type="number" name="shipping_cost" class="form-control" readonly value="0.00" step="any"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="paying_amount" class="form-control" id="paying-amount" step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>{{trans('file.Paying Amount')}} *</label>
                                                <input type="text" name="paid_amount" class="form-control" id="paid-amount" step="any"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                    ...
                    <form>
                        <div class="row modal-element">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" id="totalquantity" name="edit_qty" class="form-control" step="any">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>{{trans('file.Unit Discount')}}</label>
                                <input type="text" name="edit_discount" class="form-control" step="any">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>{{trans('file.Unit Cost')}}</label>
                                <input type="text" id="totalunitcost" name="edit_unit_price" class="form-control" step="any">
                            </div>
                            <?php
                            $tax_name_all[] = 'No Tax';
                            $tax_rate_all[] = 0;
                            ...
                            <div class="col-md-4 form-group">
                                <label>{{trans('file.Total cost')}}</label>
                                <input type="text" id="totalproductcost" name="total_product_cost" class="form-control" value="0.00">
                            </div>
                        </div>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<td>' + data[1] + '</td>';
                cols += '<td><input type="text" class="form-control qty" name="qty[]" value="'+data[15]+'" step="any" required/></td>';
                // if(data[12]) {
...
$('select[name="payment_status"]').on("change", function() {
    ...
    var grand = $('input[name="grand_total"]').val();
    var ship = $('input[name="shipping_cost"]').val();

    var receive = (grand-ship);
    if (payment_status == 3 || payment_status == 4) {
        $("#paid-amount").prop('readonly',false);
        $("#payment").show();
        $("#paying-amount").prop('required',true);
        $("#paying-amount").prop('readonly',true);
        $("#paid-amount").prop('required',true);
        if(payment_status == 4){
            $("#paid-amount").prop('readonly',true);
            $('input[name="paying_amount"]').val(receive);
            $('input[name="paid_amount"]').val(receive);
...
$(document).on('submit', '.payment-form', function(e) {
    ...
    $("#totalquantity").keyup(function(){
        var totalqty = parseFloat($("#totalquantity").val());
        var totalcost = parseFloat($("#totalproductcost").val());
        var totalunitcost = parseFloat($("#totalunitcost").val());
        var totalCalunitprice =parseFloat((totalcost/totalqty));
        var totalCalproCost =parseFloat((totalCalunitprice*totalqty));

        $("#totalunitcost").val(totalCalunitprice);
        // $("#totalproductcost").val(totalCalproCost.toFixed(2));

    });

    $("#totalproductcost").keyup(function(){
        var totalqty = parseFloat($("#totalquantity").val());
        var totalcost = parseFloat($("#totalproductcost").val());
        var totalCalAmount =parseFloat((totalcost/totalqty));

        $("#totalunitcost").val(totalCalAmount);
    });

    $("#totalunitcost").keyup(function(){
        var totalqty = parseFloat($("#totalquantity").val());
        var totalunitcost = parseFloat($("#totalunitcost").val());
        var totalCalAmount =parseFloat((totalunitcost*totalqty));

        $("#totalproductcost").val(totalCalAmount.toFixed(2));
    });
    ...
    $('.add-more-agency').on("click", function() {
        ...
        $('div#agencyHide').append(
            $('<div>').attr({'class':'col-md-12 mt-3', 'id':'allAgencyRow'+id}).append(
    ...
    function getShipCost(shipId,e) {
        var per_ship_cost = 0;
        var total_ship_cost = parseFloat($(".getShippingCost").val());
