                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="lc_no" class="form-control lchiddenId" data-live-search="true" data-live-search-style="begins" id="lc_num" onchange="changeWarehouse(this);" title="Select lc no...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="from_warehouse_id" class="selectpicker form-control" id="from-warehouse-id">
...
{{--                                                    <th></th>--}}
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.Shipping Total Cost')}}</label>
                                            <input type="text" name="shipping_cost" class="form-control" readonly value="0.00" step="any"/>
                                        </div>
                                    </div>
                                </div>
...
//     alert('ok')
//     $.ajax({
//         url: 'warehouseId/'+$("#lc_num").val(),
//         type: "GET",
//         dataType: "json",
//         success:function(data) {
//
//             $('select[name="from_warehouse_id"]').empty();
//             $.each(data, function(key, value) {
//                 $('select[name="from_warehouse_id"]').append('<option value="'+ key +'">'+ value +'</option>').change();
//                 });
...
$('#lims_productcodeSearch').on('input', function(){
    ...
    // var lcnum = $('#lc_num').val(this.lcNo);
