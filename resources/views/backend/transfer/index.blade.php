        ...
        <div class="card">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3 mt-3 @if(\Auth::user()->role_id > 2){{'d-none'}}@endif">
                    <div class="form-group">
                        <label class="">{{trans('file.From')}} &nbsp;</label>
                            <select id="from_warehouse_id" name="from_warehouse_id" class="selectpicker form-control" data-live-search-style="begins" >
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<h1 class="text-center">Transfer List</h1><hr>'
                },
                action: function(e, dt, button, config) {
                    datatable_sum(dt, true);
