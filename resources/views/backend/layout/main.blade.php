  ...
  <body @if($theme == 'dark') class="dark-mode dripicons-brightness-low" @else class="" @endif onload="myFunction()">
    <div id="loader"></div>
      ...
      <nav class="side-navbar">
        <span class="brand-big">
            ...
            <a href="{{url('/')}}"><img src="{{url('logo', $general_setting->site_logo)}}" width="100"></a>
            @else
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            <ul id="sale" class="collapse list-unstyled ">
                ...
                <li><a href="{{route('sale.pos')}}">Cash Sale</a></li>
            ...
            <?php
                ...
                $agency_index_permission_active = DB::table('permissions')
                    ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                    ->where([
                        ['permissions.name', 'agency-index'],
                        ['role_id', $role->id]
                    ])->first();
            ?>
            @if($user_index_permission_active || $customer_index_permission_active || $biller_index_permission_active || $supplier_index_permission_active || $agency_index_permission_active)
            ...
            <ul id="people" class="collapse list-unstyled ">
                ...
                @if($agency_index_permission_active)
                    <li id="agency-list-menu"><a href="{{route('agency.index')}}">{{trans('file.Agency List')}}</a></li>
                    <?php
                    $agency_add_permission_active = DB::table('permissions')
                        ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                        ->where([
                            ['permissions.name', 'agency-add'],
                            ['role_id', $role->id]
                        ])->first();
                    ?>
                    @if($agency_add_permission_active)
                        <li id="agency-create-menu"><a href="{{route('agency.create')}}">{{trans('file.Add Agency')}}</a></li>
                    @endif
                @endif
            </ul>
            </li>
            ...
            <?php
                ...
                $lc_report_active = DB::table('permissions')
                ->join('role_has_permissions', 'permissions.id', '=', 'role_has_permissions.permission_id')
                ->where([
                    ['permissions.name', 'lc-report'],
                    ['role_id', $role->id]
                ])->first();
            ...
            <ul id="report" class="collapse list-unstyled ">
                ...
                <li id="due-report-menu">
                    <a id="customer-due-report-link" href="">{{trans('file.Customer Due Report')}}</a>
                </li>
                @endif
                ...
                @endif
                @if($lc_report_active)
                    <li id="lc-report-menu">
                        <a id="lc-report-link" href="">{{trans('file.LC Report')}}</a>
                    </li>
                @endif
            </ul>
            </li>
    ...
    <div class="page">
      ...
      <header class="container-fluid">
        <nav class="navbar">
            ...
            ?>
            @if($sale_add_permission_active)
            <li class="nav-item"><a class="dropdown-item btn-pos btn-sm" href="{{route('sale.pos')}}"><i class="dripicons-shopping-bag"></i><span> Cash Sale</span></a></li>
            @endif
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" data-dismiss="modal" aria-label="Close" class="close" onclick="ResetFrom();"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                </div>
                <div class="modal-body">
                  <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                    {!! Form::open(['route' => 'accounts.statement', 'method' => 'post', 'id'=>'statement-form']) !!}
                      <div class="row">
                        <div class="col-md-6 form-group">
                            <label> {{trans('file.Account')}}</label>
                            <select class="form-control selectpicker" name="account_id">
      ...
      <!-- end user modal -->
        ...
        <!-- lc report modal -->
        <div id="lcReport-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="examplelcModalLabel" class="modal-title">{{trans('file.LC Report')}}</h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        ...
                        <?php
                        $lims_lcno_list = DB::table('purchases')->where('lc_no','!=', null)->get();
                        ?>
                        <div class="form-group">
                            <label>{{trans('file.LC No')}} *</label>
                            <select name="lc_no" class="selectpicker form-control" required data-live-search="true" id="lc_num" data-live-search-style="begins" title="Select lc no...">
      ...
      <!-- end customer modal -->
        ...
        <!-- customer due report modal -->
        <div id="customer-due-report-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{trans('file.Customer Due Report')}}</h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
      ...
      <!-- end supplier modal -->
        ...
        <!-- supplier due report modal -->
        <div id="supplier-due-report-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{trans('file.Supplier Due Report')}}</h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
    ...
    <script type="text/javascript">
      ...
      $("a#user-report-link").click(function(e){
        ...
        $("a#lc-report-link").click(function(e){
            e.preventDefault();
            $('#lcReport-modal').modal();
        });
      ...
      $("a#customer-due-report-link").click(function(e){
        e.preventDefault();
        $('#customer-due-report-modal').modal();
      });
      ...
      $("a#supplier-due-report-link").click(function(e){
          e.preventDefault();
          $('#supplier-due-report-modal').modal();
      });
