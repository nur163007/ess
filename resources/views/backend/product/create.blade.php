                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 hidden">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" class="form-control" step="any" value="0">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alert_quantity" class="form-control" step="any">
                                        <span class="validation-msg" id="code-alertQty"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(flag){
                        ...
                        cols += '<td><input type="text" class="form-control unit_price" name="unit_price[]" value="' + data[2] + '" step="any"/></td>';
    ...
    myDropzone = new Dropzone('div#imageUpload', {
                    ...
                    if(myDropzone.getAcceptedFiles().length) {
                        ...
                        $.ajax({
                            ...
                            error:function(response) {
                              ...
                              else if(response.responseJSON.errors.alert_quantity) {
                                  $("#code-alertQty").text(response.responseJSON.errors.alert_quantity);
                              }
                            },
                        });
                    }
        ...
        error: function (file, response) {
            ...
            else if(response.errors.alert_quantity) {
              $("#code-alertQty").text(response.errors.alert_quantity);
              this.removeAllFiles(true);
            }
            else {
              try {
