...
<div id="product-details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
{{--          <h2 id="authorCo" class="modal-title" style="text-align: left;margin: 15px;">Fakhor Uddin Brothers</h2>--}}
        <div class="modal-header">
          <h1 id="exampleModalLabel" class="modal-title">{{trans('Product Details')}}</h1>
...
<script>
    ...
    $("#print-btn").on("click", function() {
          ...
          newWin.document.write('<link rel="stylesheet" href="<?php echo asset('vendor/bootstrap/css/bootstrap.min.css') ?>" type="text/css"><style type="text/css">@media print {.modal-dialog { max-width: 1000px;} #print-btn {display: none;}  }</style><body onload="window.print()">'+divToPrint.innerHTML+'</body>');
            ...
            buttons: [
                ...
                },
                {
                    ...
                    repeatingHead: {
                        ...
                        logoPosition: 'center',
                        logoStyle: '',
                        title: '<h1 class="text-center">Product List</h1><hr>'
                    },
