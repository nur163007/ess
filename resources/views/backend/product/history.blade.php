            ...
            <div class="row ml-1">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <h4 class="mt-4" id="product_name">{{$product_data->name.' ['.$product_data->code.']'}}</h4>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<h1 class="text-left"><b>Product sale history</b></h1><br>' +
                        '<h3 class="text-left">Product name: '+product_name+'</h3><hr>'
                },
            },
            {
                extend: 'colvis',
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<h1 class="text-left"><b>Product purchase history</b></h1><br>' +
                        '<h3 class="text-left">Product name: '+product_name+'</h3><hr>'
                },
            },
            {
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<h1 class="text-left"><b>Product sale retrun history</b></h1><br>' +
                        '<h3 class="text-left">Product name: '+product_name+'</h3><hr>'
                },
            },
            {
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<h1 class="text-left"><b>Product purchase return history</b></h1><br>' +
                        '<h3 class="text-left">Product name: '+product_name+'</h3><hr>'
                },
            },
            {
