...
<script type="text/javascript">
    ...
    var user_email;
        ...
        user_name = <?php echo json_encode($lims_user->name)?>;
        user_phone = <?php echo json_encode($lims_user->phone) ?>;
        user_email = <?php echo json_encode($lims_user->email) ?>;
        if(user_phone != null){
            user_phone = <?php echo json_encode($lims_user->phone) ?>;
        }
        else{
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>User sale report</b></h1><br>' +
                        '<h3 class="text-left">User name  : '+user_name+'</h3><br>' +
                        '<h3 class="text-left">User phone : '+user_phone+'</h3><br>' +
                        '<h3 class="text-left">User email : '+user_email+'</h3><hr><br>'
                },
                action: function(e, dt, button, config) {
                    datatable_sum_sale(dt, true);
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>User purchase report</b></h1><br>' +
                        '<h3 class="text-left">User name  : '+user_name+'</h3><br>' +
                        '<h3 class="text-left">User phone : '+user_phone+'</h3><br>' +
                        '<h3 class="text-left">User email : '+user_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>User quotation report</b></h1><br>' +
                        '<h3 class="text-left">User name  : '+user_name+'</h3><br>' +
                        '<h3 class="text-left">User phone : '+user_phone+'</h3><br>' +
                        '<h3 class="text-left">User email : '+user_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>User transfer report</b></h1><br>' +
                        '<h3 class="text-left">User name  : '+user_name+'</h3><br>' +
                        '<h3 class="text-left">User phone : '+user_phone+'</h3><br>' +
                        '<h3 class="text-left">User email : '+user_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>User payment report</b></h1><br>' +
                        '<h3 class="text-left">User name  : '+user_name+'</h3><br>' +
                        '<h3 class="text-left">User phone : '+user_phone+'</h3><br>' +
                        '<h3 class="text-left">User email : '+user_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>User expense report</b></h1><br>' +
                        '<h3 class="text-left">User name  : '+user_name+'</h3><br>' +
                        '<h3 class="text-left">User phone : '+user_phone+'</h3><br>' +
                        '<h3 class="text-left">User email : '+user_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>User payroll report</b></h1><br>' +
                        '<h3 class="text-left">User name  : '+user_name+'</h3><br>' +
                        '<h3 class="text-left">User phone : '+user_phone+'</h3><br>' +
                        '<h3 class="text-left">User email : '+user_email+'</h3><hr><br>'
                },
