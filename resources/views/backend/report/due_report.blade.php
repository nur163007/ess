...
{{--                    <td>{{$sale_data->reference_no}}</td>--}}
                    ...
                    <td>{{number_format((float)($sale_data->total_price - $sale_data->order_discount), 2, '.', '')}}</td>
                    ...
                    <td>0.00</td>
                    @endif
                    <td>{{number_format((float)(($sale_data->total_price - $sale_data->order_discount) - $returned_amount - $sale_data->paid_amount), 2, '.', '')}}</td>
...
<script type="text/javascript">
    ...
    if(customer_name !=null){
        customer_name = <?php echo json_encode($customer_info->name) ?>;
    }else{
        customer_name = 'N/A';
    }
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Customer due report</b></h1><br>' +
