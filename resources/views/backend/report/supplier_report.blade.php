        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Supplier purchase report</b></h1><br>' +
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Supplier payment report</b></h1><br>' +
                        '<h3 class="text-left">Supplier name  : '+supplier_name+'</h3><br>' +
                        '<h3 class="text-left">Supplier phone : '+supplier_phone+'</h3><br>' +
                        '<h3 class="text-left">Supplier email : '+supplier_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Supplier returns report</b></h1><br>' +
                        '<h3 class="text-left">Supplier name  : '+supplier_name+'</h3><br>' +
                        '<h3 class="text-left">Supplier phone : '+supplier_phone+'</h3><br>' +
                        '<h3 class="text-left">Supplier email : '+supplier_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Supplier quotation report</b></h1><br>' +
                        '<h3 class="text-left">Supplier name  : '+supplier_name+'</h3><br>' +
                        '<h3 class="text-left">Supplier phone : '+supplier_phone+'</h3><br>' +
                        '<h3 class="text-left">Supplier email : '+supplier_email+'</h3><hr><br>'
                },
