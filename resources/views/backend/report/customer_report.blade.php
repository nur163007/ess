...
{{--                            <td>{{$sale->reference_no}}</td>--}}
                            ...
                            <td>{{number_format((float)($sale->total_price / $sale->total_qty), 2, '.', '')}}</td>
                            <td>{{number_format((float)($sale->grand_total - $sale->shipping_cost), 2, '.', '')}}</td>
                            <td>{{$sale->paid_amount}}</td>
                            <td>{{number_format((float)($sale->grand_total - $sale->paid_amount - $sale->shipping_cost), 2, '.', '')}}</td>
                            @if($sale->sale_note)
                    ...
                    <tbody>
                        @foreach($lims_payment_data as $key=>$payment)
                            <tr>
                                ...
                                <td>{{$payment->paying_method.' ( '.$payment->account_name.' ) '}}</td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot class="tfoot active">
...
<script type="text/javascript">
    ...
    var customer_name = <?php echo json_encode($customer_info->name) ?>;
    var customer_phone = <?php echo json_encode($customer_info->phone_number) ?>;
    var customer_email = <?php echo json_encode($customer_info->email) ?>;
    if(customer_phone != null){
        customer_phone = <?php echo json_encode($customer_info->phone_number) ?>;
    }
    else{
        customer_phone = 'N/A';
    }
    ...
    if(customer_email != null){
        customer_email = <?php echo json_encode($customer_info->email) ?>;
    }
    else{
        customer_email = 'N/A';
    }
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Customer sale report</b></h1><br>' +
                        '<h3 class="text-left">Customer name  : '+customer_name+'</h3><br>' +
                        '<h3 class="text-left">Customer phone : '+customer_phone+'</h3><br>' +
                        '<h3 class="text-left">Customer email : '+customer_email+'</h3><hr><br>'
                },
                action: function(e, dt, button, config) {
                    datatable_sum_sale(dt, true);
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Customer payment report</b></h1><br>' +
                        '<h3 class="text-left">Customer name  : '+customer_name+'</h3><br>' +
                        '<h3 class="text-left">Customer phone : '+customer_phone+'</h3><br>' +
                        '<h3 class="text-left">Customer email : '+customer_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Customer sale return report</b></h1><br>' +
                        '<h3 class="text-left">Customer name  : '+customer_name+'</h3><br>' +
                        '<h3 class="text-left">Customer phone : '+customer_phone+'</h3><br>' +
                        '<h3 class="text-left">Customer email : '+customer_email+'</h3><hr><br>'
                },
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<br><h1 class="text-left"><b>Customer sale quotation report</b></h1><br>' +
                        '<h3 class="text-left">Customer name  : '+customer_name+'</h3><br>' +
                        '<h3 class="text-left">Customer phone : '+customer_phone+'</h3><br>' +
                        '<h3 class="text-left">Customer email : '+customer_email+'</h3><hr><br>'
                },
