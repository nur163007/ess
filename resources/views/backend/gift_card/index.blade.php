...
{{--          <h2 class="m-3"> Fakhor Uddin Brothers</h2>--}}
          <div class="modal-header">
              <h1 id="exampleModalLabel" class="modal-title"> {{trans('file.Card Details')}} &nbsp;&nbsp;</h1>
        ...
        buttons: [
            ...
            },
            {
                ...
                repeatingHead: {
                    ...
                    logoPosition: 'center',
                    logoStyle: '',
                    title: '<h1 class="text-center">Gift cards List</h1><hr>'
                },
                action: function(e, dt, button, config) {
                    datatable_sum(dt, true);
