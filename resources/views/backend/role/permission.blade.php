                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
                                ...
                                <tr>
                                    <td>{{trans('file.Agency')}}</td>
                                    <td class="text-center">
                                        <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                                            <div class="checkbox">
                                                @if(in_array("agency-index", $all_permission))
                                                    <input type="checkbox" value="1" id="agency-index" name="agency-index" checked>
                                                @else
                                                    <input type="checkbox" value="1" id="agency-index" name="agency-index">
                                                @endif
                                                <label for="agency-index"></label>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                                            <div class="checkbox">
                                                @if(in_array("agency-add", $all_permission))
                                                    <input type="checkbox" value="1" id="agency-add" name="agency-add" checked>
                                                @else
                                                    <input type="checkbox" value="1" id="agency-add" name="agency-add">
                                                @endif
                                                <label for="agency-add"></label>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                                            <div class="checkbox">
                                                @if(in_array("agency-edit", $all_permission))
                                                    <input type="checkbox" value="1" id="agency-edit" name="agency-edit" checked>
                                                @else
                                                    <input type="checkbox" value="1" id="agency-edit" name="agency-edit">
                                                @endif
                                                <label for="agency-edit"></label>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                                            <div class="checkbox">
                                                @if(in_array("agency-delete", $all_permission))
                                                    <input type="checkbox" value="1" id="agency-delete" name="agency-delete" checked>
                                                @else
                                                    <input type="checkbox" value="1" id="agency-delete" name="agency-delete">
                                                @endif
                                                <label for="agency-delete"></label>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
						        ...
						        <tr>
						            ...
						            <td class="report-permissions" colspan="5">
                                        ...
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("lc-report", $all_permission))
                                                        <input type="checkbox" value="1" id="lc-report" name="lc-report" checked>
                                                    @else
                                                        <input type="checkbox" value="1" id="lc-report" name="lc-report">
                                                    @endif
								                    <label for="lc-report" class="padding05">{{trans('file.LC Report')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
						        ...
						        <tr>
						            <td>{{trans('file.Payment Options')}}</td>
						            <td class="report-permissions" colspan="5">
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("card", $all_permission))
							                    	<input type="checkbox" value="1" id="card" name="card" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="card" name="card">
							                    	@endif
								                    <label for="card" class="padding05">{{trans('file.Card')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("cash", $all_permission))
							                    	<input type="checkbox" value="1" id="cash" name="cash" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="cash" name="cash">
							                    	@endif
								                    <label for="cash" class="padding05">{{trans('file.Cash')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("paypal", $all_permission))
							                    	<input type="checkbox" value="1" id="paypal" name="paypal" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="paypal" name="paypal">
							                    	@endif
								                    <label for="paypal" class="padding05">{{trans('file.PayPal')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	@if(in_array("cheque", $all_permission))
							                    	<input type="checkbox" value="1" id="cheque" name="cheque" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="cheque" name="cheque">
							                    	@endif
								                    <label for="cheque" class="padding05">{{trans('file.Cheque')}} &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            </td>
