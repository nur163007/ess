...
Route::group(['middleware' => ['common', 'auth', 'active']], function() {
    ...
    Route::get('suppliers/getpayment/{id}', 'SupplierController@getPayment')->name('suppliers.get-payment');
    Route::post('suppliers/clear-due', 'SupplierController@clearDue')->name('supplier.clearDue');
	Route::resource('supplier', 'SupplierController');

	//AGENCY MODULE
    Route::post('importagency', 'AgencyController@importAgency')->name('agency.import');
    Route::post('agency/deletebyselection', 'AgencyController@deleteBySelection');
    Route::get('agency/getpayment/{id}', 'AgencyController@getPayment')->name('agency.get-payment');
    Route::post('agency/clear-due', 'AgencyController@clearDue')->name('agency.clearDue');
    ...
    Route::get('customers/getpayment/{id}', 'CustomerController@getPayment')->name('customers.get-payment');
    ...
    Route::get('purchases/agency/getagencydata', 'PurchaseController@getAllAgency')->name('agency.getAllAgency');
	...
	Route::get('transfers/warehouseId/{lcno}','TransferController@getWarehouse');
	...
	Route::get('transfers/getproduct/{id}/{lcno}', 'TransferController@getProduct')->name('transfer.getproduct');
	...
	Route::post('report/lc_report', 'ReportController@lcReport')->name('report.lc');
